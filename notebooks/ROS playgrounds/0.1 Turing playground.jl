...
md" ##### Over time I plan to expand below the list of topics:
...
let
	...
	error_bars = nested_column_to_array(errorbars_draws(pred1_1t, [0.25, 0.75]), "q")
	errorbars!(x_test, pred_values, error_bars[:, 1], error_bars[:, 2], whiskerwidth = 6, color=:grey)

	# 89% s.e. of the mean
	error_bars = nested_column_to_array(errorbars_mean(pred1_1t, [0.055, 0.945]), :q)
...
manifest_format = "2.0"
project_hash = "660d2bfc263cd2491e8515512463982efecb0375"
